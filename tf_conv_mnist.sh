...
#python tf_conv_mnist.py 16 parameterization
#python tf_conv_mnist.py 16 riemannian
#python tf_conv_mnist.py 8 parameterization
#python tf_conv_mnist.py 8 riemannian
